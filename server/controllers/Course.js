...
exports.createCourse = async (req, res) => {
  try {
    ...
    try {
      ...
      tag = Array.isArray(_tag) ? _tag : (_tag ? [_tag] : ["Coding"]);
    }
    ...
    try {
      ...
      instructions = Array.isArray(_instructions) ? _instructions : (_instructions ? [_instructions] : ["Follow course guidelines"]);
    }
    ...
    // Upload the Thumbnail to Cloudinary or fallback
    let thumbnailImage = { secure_url: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=800&auto=format&fit=crop&q=60" };
    if (thumbnail) {
